...
#' @param Ps_col The name of the column containing the probability of survival (Ps) values.
...
#'
#' @return A data frame containing the Ps ranges, the fraction of patients in each range in the current population,
