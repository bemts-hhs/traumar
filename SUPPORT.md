...
Thanks for using traumar! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/bemts-hhs/traumar/issues/new).
...
requests](https://github.com/bemts-hhs/traumar/issues) to make sure the
...
Please don’t worry if you do not get an immediate response, I will try
...
your concern quickly. Remember, if I cannot reproduce your problem, I
