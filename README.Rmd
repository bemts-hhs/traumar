...
[bemts-hhs/github.io/trauma](https://bemts-hhs/github.io/trauma) where you can
...
[Napoli et al.(2017)](https://www.tandfonline.com/doi/abs/10.1080/24725579.2017.1325948)
...
methodology.  Given that the majority of patients seen at trauma centers will
have a probability of survival over 90%, estimating performance based on the
W-Score may only indicate how well a center performed with lower acuity
...
Relative Mortality Metric (RMM) has a scale from -1 to 1, where
