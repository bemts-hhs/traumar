...
This function checks if an input is of the specified data structure
type(s). Depending on the specified type, it will either throw an error,
issue a warning, or send a message. It also checks for NULL and NA
...
- structure_type:
  ...
  A vector of data structure types to check. Possible values are
  "data.frame", "matrix", "list", "array", "atomic_vector", "tbl_df",
  "tbl".
