...
This outlines how to propose a change to traumar. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("bemts-hhs/traumar", fork = TRUE)`.
...
Code of
Conduct](https://bemts-hhs.github.io/traumar/CODE_OF_CONDUCT.md). By
